...
export const metadata: Metadata = {
  ...
  description:
    "The job site tool for painting contractors. Log walls, track approvals, and ship invoices — all in one place. No app store needed.",
  openGraph: {
    title: "Wallo — Job Management for Painting Contractors",
    description:
      "Log walls, track approvals, ship invoices. Built for painting contractors.",
    url: "https://wallo.cc",
  },
};
...
const jsonLd = {
  ...
  description:
    "Job management platform for painting contractors. Log walls, track approvals, and generate professional reports.",
  offers: {
    "@type": "Offer",
    price: "0",
    priceCurrency: "INR",
...
export default function LandingPage() {
  return (
    <>
      ...
      {/* Auth redirect — invisible, client-only */}
      <LandingRedirect />
      ...
      <main className="landing-bg min-h-svh relative overflow-hidden">
        ...
        <div className="lg:hidden relative z-10 flex flex-col min-h-svh w-full max-w-97.5 mx-auto sm:max-w-105">
          <div className="flex-1 px-8 pt-30">
            <div className="w-16 h-16 rounded-2xl overflow-hidden shadow-[0_8px_30px_oklch(0.62_0.14_300/0.45)]">
          ...
          <div className="px-6 pb-14 flex flex-col gap-2.5">
            ...
            <p className="text-center mt-2 text-[11px] text-white/40 tracking-[.04em]">
              v1 · BUILT FOR THE TRADES
            </p>
            <p className="text-center text-[10px] text-white/20">
              <a href="https://www.flaticon.com/free-icons/roller-paint" title="roller paint icons" target="_blank" rel="noopener noreferrer" className="text-white/20 underline-offset-2 hover:text-white/35 transition-colors">
                Icon by Graphix&apos;s Art – Flaticon
              </a>
            </p>
          </div>
        </div>
        ...
        <div className="hidden lg:flex relative z-10 min-h-svh items-center justify-center px-16">
          ...
          {/* Attribution — desktop */}
          <p className="absolute bottom-6 right-8 text-[10px] text-white/20">
            <a href="https://www.flaticon.com/free-icons/roller-paint" title="roller paint icons" target="_blank" rel="noopener noreferrer" className="text-white/20 hover:text-white/35 transition-colors">
              Icon by Graphix&apos;s Art – Flaticon
            </a>
          </p>
        </div>
